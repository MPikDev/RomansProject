...
class CompanyInfo(models.Model):
    ...
    website_link = models.CharField(max_length=128, default="")
    ...
    n_of_wait = models.IntegerField(blank=True, null=True)
    max_wait = models.FloatField(blank=True, null=True)
    min_wait = models.FloatField(blank=True, null=True)
    average_load = models.FloatField(blank=True, null=True)
    n_of_load = models.IntegerField(blank=True, null=True)
    max_load = models.FloatField(blank=True, null=True)
    min_load = models.FloatField(blank=True, null=True)
...
class CompanyInfoEntry(models.Model):
    ...
    company_info = models.ForeignKey(CompanyInfo, on_delete=models.CASCADE, null=True, default=None, blank=True)
    company_name = models.CharField(max_length=48)
    created_at = models.DateTimeField(auto_now_add=True)
    open_time = models.TimeField(blank=True, null=True)
    close_time = models.TimeField(blank=True, null=True)
